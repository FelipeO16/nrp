...
--[[   local source = vRP.getUserSource(user_id)
  if source then
    vRPclient._setDiv(source,"money",cfg.display_css,lang.money.display({addComma(value)}))
    SetTimeout(5000, function()
      vRPclient._removeDiv(source,"money")
    end)
  end ]]
end
...
--[[ AddEventHandler("vRP:playerSpawn",function(user_id, source, first_spawn)
  if first_spawn then
    -- add money display
    vRPclient._setDiv(source,"money",cfg.display_css,lang.money.display({addComma(vRP.getMoney(user_id))}))
    SetTimeout(5000, function()
      vRPclient._removeDiv(source,"money")
    end)
  end
