...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(1)
		if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), 809.96,-262.43,65.75,true) <= 1 then
			DrawText3Ds(809.96,-262.43,65.75+0.5,"PRESSIONE ~r~E~w~ PARA COMEÇAR O TRAMPO")
		...
		if emservico then
			...
			if statuses then
				...
				drawTxt(ui.right_x+0.0310,ui.bottom_y-0.028,1.0,1.0,0.45,"ENTREGUE ~g~"..quantidade.."~w~ MACONHAS",255,255,255,255)
			else
